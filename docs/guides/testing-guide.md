...
│   ├── stdlib/                     # Interpreter stdlib tests (modular)
│   │   ├── mod.rs                  # Common utilities (eval_ok, eval_err)
│   │   ├── array_pure.rs           # Non-callback array functions
│   │   ├── array_intrinsics.rs     # Callback-based array functions
│   │   ├── math_basic.rs           # Basic math operations
│   │   ├── math_trig.rs            # Trigonometric functions
│   │   └── math_utils_constants.rs # Math utilities & constants
│   ├── vm/                         # VM stdlib tests (parity with stdlib/)
│   │   ├── mod.rs                  # Common utilities (execute_vm_ok, execute_vm_err)
│   │   ├── array_pure.rs           # VM version of stdlib tests
│   │   ├── array_intrinsics.rs     # VM version of stdlib tests
│   │   ├── math_basic.rs           # VM version of stdlib tests
│   │   ├── math_trig.rs            # VM version of stdlib tests
│   │   └── math_utils_constants.rs # VM version of stdlib tests
...
**Modular stdlib/vm structure:**
- Each module focuses on a specific API (arrays, math, strings, etc.)
- VM tests mirror stdlib tests to ensure interpreter/VM parity
- Helper utilities in mod.rs reduce boilerplate
- All test files stay under 800 lines for maintainability
