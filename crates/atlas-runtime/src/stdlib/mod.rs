...
fn builtin_registry() -> &'static HashMap<&'static str, BuiltinFn> {
    BUILTIN_REGISTRY.get_or_init(|| {
        ...
        m.insert("split", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let sep = extract_string(&args[1], span)?;
        ...
        m.insert("join", |args, span, _, _| {
            ...
            let arr = extract_array(&args[0], span)?;
            let sep = extract_string(&args[1], span)?;
        ...
        m.insert("indexOf", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let search = extract_string(&args[1], span)?;
        ...
        m.insert("substring", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let start = extract_number(&args[1], span)?;
            let end = extract_number(&args[2], span)?;
        ...
        m.insert("charAt", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let index = extract_number(&args[1], span)?;
        ...
        m.insert("repeat", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let count = extract_number(&args[1], span)?;
        ...
        m.insert("replace", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let search = extract_string(&args[1], span)?;
            let replacement = extract_string(&args[2], span)?;
        ...
        m.insert("padStart", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let length = extract_number(&args[1], span)?;
            let fill = extract_string(&args[2], span)?;
        ...
        m.insert("startsWith", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let prefix = extract_string(&args[1], span)?;
        ...
        m.insert("endsWith", |args, span, _, _| {
            ...
            let s = extract_string(&args[0], span)?;
            let suffix = extract_string(&args[1], span)?;
        ...
        m.insert("concat", |args, span, _, _| {
            ...
            let arr1 = extract_array(&args[0], span)?;
            let arr2 = extract_array(&args[1], span)?;
        ...
        m.insert("expect", |args, span, _, _| {
            ...
            let message = extract_string(&args[1], span)?;
            match &args[0] {
        ...
        m.insert("pathJoinArray", |args, span, _, _| {
            ...
            let segments = extract_array(&args[0], span)?;
        ...
        m.insert("pathParse", |args, span, _, _| {
            ...
            let path_str = extract_string(&args[0], span)?;
        ...
        m.insert("pathRelative", |args, span, _, _| {
            ...
            let from = extract_string(&args[0], span)?;
            let to = extract_string(&args[1], span)?;
        ...
        m.insert("pathEquals", |args, span, _, _| {
            ...
            let path1 = extract_string(&args[0], span)?;
            let path2 = extract_string(&args[1], span)?;
        ...
        m.insert("fsMkdir", |args, span, _, _| {
            ...
            let path = extract_string(&args[0], span)?;
            fs::mkdir(path, span)
        });
        ...
        m.insert("fsFilterEntries", |args, span, _, _| {
            ...
            let entries = extract_array(&args[0], span)?;
            let pattern = extract_string(&args[1], span)?;
        ...
        m.insert("fsTmpfileNamed", |args, span, _, _| {
            ...
            let prefix = extract_string(&args[0], span)?;
        ...
        m.insert("fsSymlink", |args, span, _, _| {
            ...
            let target = extract_string(&args[0], span)?;
            let link = extract_string(&args[1], span)?;
