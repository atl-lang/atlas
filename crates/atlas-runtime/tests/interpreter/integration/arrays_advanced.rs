...
fn test_cow_cloned_array_gets_mutation() {
    assert_eval_number(
        "let mut a: array = [1, 2, 3]; let mut b: array = a; b[0] = 99; b[0];",
        99.0,
    );
}
...
fn test_array_compound_assign_add() {
    assert_eval_number(
        "let mut arr: array = [10, 20, 30]; arr[1] += 5; arr[1];",
        25.0,
    );
}
...
fn test_array_multiple_mutations_accumulate() {
    assert_eval_number(
        "let mut arr: array = [0, 0, 0]; arr[0] = 10; arr[1] = 20; arr[2] = 30; arr[0] + arr[1] + arr[2];",
        60.0,
    );
}
...
fn test_array_method_push_updates_receiver() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2, 3]; arr.push(4); arr[3];"#,
        4.0,
    );
}
...
fn test_array_method_push_increases_len() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2]; arr.push(3); len(arr);"#,
        3.0,
    );
}
...
fn test_array_method_push_multiple() {
    assert_eval_number(
        r#"let mut arr: array = []; arr.push(10); arr.push(20); arr.push(30); arr[1];"#,
        20.0,
    );
}
...
fn test_array_method_pop_returns_element() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2, 3]; let x = arr.pop(); x;"#,
        3.0,
    );
}
...
fn test_array_method_pop_shrinks_receiver() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2, 3]; arr.pop(); len(arr);"#,
        2.0,
    );
}
...
fn test_array_method_pop_receiver_correct() {
    assert_eval_number(
        r#"let mut arr: array = [10, 20, 30]; arr.pop(); arr[0] + arr[1];"#,
        30.0,
    );
}
...
fn test_array_method_sort_returns_sorted() {
    assert_eval_number(
        r#"let mut arr: array = [3, 1, 2]; let s = arr.sort(); s[0];"#,
        1.0,
    );
}
...
fn test_array_method_sort_non_mutating() {
    assert_eval_number(
        r#"let mut arr: array = [3, 1, 2]; let s = arr.sort(); arr[0];"#,
        3.0,
    );
}
...
fn test_array_method_sort_numeric() {
    assert_eval_number(
        r#"let mut arr: array = [10, 2, 30, 4]; let s = arr.sort(); s[0];"#,
        2.0,
    );
}
...
fn test_array_method_reverse_updates_receiver() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2, 3]; arr.reverse(); arr[0];"#,
        3.0,
    );
}
...
fn test_array_method_reverse_result_correct() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2, 3]; let r = arr.reverse(); r[0];"#,
        3.0,
    );
}
...
fn test_free_fn_pop_cow_writeback() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2, 3]; let x = pop(arr); len(arr);"#,
        2.0,
    );
}
...
fn test_free_fn_pop_returns_element() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2, 3]; let x = pop(arr); x;"#,
        3.0,
    );
}
...
fn test_free_fn_shift_cow_writeback() {
    assert_eval_number(
        r#"let mut arr: array = [10, 20, 30]; let x = shift(arr); x;"#,
        10.0,
    );
}
...
fn test_free_fn_shift_receiver_updated() {
    assert_eval_number(
        r#"let mut arr: array = [10, 20, 30]; shift(arr); len(arr);"#,
        2.0,
    );
}
...
fn test_free_fn_reverse_cow_writeback() {
    assert_eval_number(
        r#"let mut arr: array = [1, 2, 3]; reverse(arr); arr[0];"#,
        3.0,
    );
}
