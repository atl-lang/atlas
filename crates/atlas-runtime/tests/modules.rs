// Merged: module_binding_tests + module_execution_tests + module_execution_vm_tests + module_resolution_tests
// Each source file in its own mod to avoid import conflicts.

// ===== module_binding_tests.rs =====
