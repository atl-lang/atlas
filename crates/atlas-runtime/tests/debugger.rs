// Merged: debugger_execution_tests + debugger_inspection_tests + debugger_protocol_tests
// Each source file in its own mod to avoid import conflicts.

// ===== debugger_execution_tests.rs =====
