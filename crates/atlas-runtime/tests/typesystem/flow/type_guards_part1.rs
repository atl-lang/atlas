...
#[case(
    r#"
    fn isStr(borrow x: number | string): bool is x: string { return typeof(x) == "string"; }
...
#[case(
    r#"
    fn is_boolish(borrow x: bool | null): bool is x: bool { return typeof(x) == "bool"; }
...
#[case(
    r#"
    fn is_nullish(borrow x: null | string): bool is x: null { return typeof(x) == "null"; }
...
#[case(
    ...
    fn test(borrow x: bool | null): number {
        if (typeof(x) == "bool") { let _y: bool = x; return 1; }
...
#[case(
    r#"
    fn test(borrow x: null | string): number {
        if (typeof(x) == "null") { let _y: null = x; return 1; }
        else { let _y: string = x; return 2; }
    }
    "#
)]
...
#[case(
    r#"
    fn isText(borrow x: number | string): bool is x: string { return typeof(x) == "string"; }
    fn test(borrow x: number | string): number {
