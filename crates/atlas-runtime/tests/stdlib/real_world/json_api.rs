...
fn test_json_parse_array() {
    let code = r#"
        ...
        let arr: json = unwrap(parseJSON(jsonStr));
...
fn test_json_api_extract_users() {
    let code = r#"
        ...
        let response: json = unwrap(parseJSON(jsonStr));
...
fn test_json_build_from_parts() {
    let code = r#"
        ...
        let parsed: json = unwrap(parseJSON(jsonStr));
...
fn test_json_github_api_style() {
    let code = r#"
        ...
        let json: json = unwrap(parseJSON(response));
