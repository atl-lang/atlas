//! Integration tests for the bytecode validator (phase-01 bytecode-vm)
//!
//! These tests validate real bytecode produced by the Atlas compiler passes
//! through the validator. Every valid program should produce `Ok(())`.
//! Malformed bytecode (hand-crafted) should produce specific errors.
