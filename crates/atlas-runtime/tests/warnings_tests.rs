//! Warning system tests (Frontend Phase-01)
//!
//! Tests warning configuration (allow/warn/deny), warning emission,
//! warning detection types, TOML config, and integration with typechecker.
