...
- Parity validation → `parity_checks` table
- Test coverage → `test_coverage` table
...
### Utilities
```bash
atlas-dev export markdown  # Generate for humans (optional)
atlas-dev export json      # Backup as JSON
atlas-dev undo             # Rollback last operation
atlas-dev backup           # Create DB backup
```
...
|-------|-------|----------|------|
| 1 | Core Infrastructure | CRITICAL | 29KB |
| 2 | Phase Management | CRITICAL | 25KB |
| 3 | Decision Logs | HIGH | 7KB |
| 4 | Analytics & Validation | HIGH | Complete |
| 5 | Context System | MEDIUM | Complete |
| 6 | Polish & Export | LOW | Complete |
| 7 | Feature Management | HIGH | 5KB |
| 8 | Spec/API Management | HIGH | 6KB |
| 9 | Parity Validation | CRITICAL | 10KB |
| 10 | Composability | MEDIUM | 8KB |
