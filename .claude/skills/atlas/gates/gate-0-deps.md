...
3. Is it complete? (`pt block B<N>` shows block AC; grep tests for coverage)
...
- 🚫 Doesn't exist → BLOCKING. Do NOT ask the user. Resolve autonomously:
  ...
  - Dependency outside v0.3 scope: `pt add "Gap: X" P1 "reason"` to document, skip phase noting why
