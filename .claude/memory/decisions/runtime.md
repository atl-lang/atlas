...
## DR-001: Memory Model — Value Semantics + Explicit Ownership
...
## DR-003: Dynamic Scoping vs Lexical Closures
...
## DR-B01-02: CoW Wrapper Types (all collections)
| Type | Rust | CoW |
|------|------|-----|
...
## DR-B03-01: Trait Method Mangled Names (Static Dispatch)
...
## DR-B03-02: Block 3 Trait Architecture Decisions
...
## DR-004: CoW Write-Back for Collection Mutation Builtins
...
## DR-B03-01: Trait Method Mangling + Static Dispatch
...
## DR-B03-02: Trait Registry Architecture
...
## DR-B03-03: LSP Partial AST on Parse Errors
...
## DR-B04-01: Zero-Allocation Interpreter Hot Path — Goal Not Gate (2026-02-23)
