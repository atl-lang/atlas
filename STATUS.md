...
**Version:** v0.2 | **Progress:** 110/133 phases (83%)
...
**Next Phase:** phases/interpreter/phase-01a-interpreter-debugger.md

> **Execution order:** Correctness (12) → Interpreter (4) → CLI (6) → LSP (5) → Polish (5)
...
| **Typing** | 7/7 | ✅ Archived |
| **Interpreter** | 0/4 | ⬜ Ready (Correctness complete) |
| **CLI** | 0/6 | ⬜ Pending |
| **LSP** | 0/5 | ⬜ Pending |
| **Polish** | 0/5 | ⬜ Pending |
...
### Interpreter (0/4) — Ready

**Debugger & REPL (split into sub-phases):**
⬜ phase-01a-interpreter-debugger.md — Interpreter debugger with VM parity (50 tests)
⬜ phase-01b-repl-commands-multiline.md — REPL commands and multi-line input (35 tests)
⬜ phase-01c-repl-usability.md — History, colors, tab completion (15 tests)

**Performance:**
⬜ phase-02-interpreter-performance-and-integration.md — Performance and integration
